  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        nav_button: cn(
          "inline-flex items-center justify-center rounded-md text-sm font-medium transition-colors size-7 bg-white border border-gray-300 p-0 opacity-70 hover:opacity-100 hover:bg-gray-50 text-gray-700"
        ),
        ...
        day: cn(
          "inline-flex items-center justify-center rounded-md text-sm font-normal size-8 p-0 aria-selected:opacity-100 hover:bg-gray-100 text-gray-900 bg-white border-0"
        ),
        day_range_start:
