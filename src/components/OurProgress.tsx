        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <Card
              ...
              year={translations.ourProgress?.year2023 || "2023"}
              desc={
            ...
            <Card
              ...
              year={
                translations.ourProgress?.talentRecruitmentPeriod ||
                "2024 - Present"
              }
              desc={
                translations.ourProgress?.talentRecruitmentDesc ||
            ...
            <Card
              ...
              year={translations.ourProgress?.year2024 || "2024"}
              desc={
                translations.ourProgress?.noStringsProgramDesc ||
            ...
            <div className="group relative">
              ...
              <div className="relative bg-white/90 backdrop-blur-xl rounded-2xl p-8 border border-purple-200/50 shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-1 h-full">
                ...
                <p className="text-base text-gray-700 leading-relaxed font-normal text-justify">
                  {showFullAiden ? aidenFullText : aidenShortText}
                </p>
                <button
                  onClick={() => setShowFullAiden(!showFullAiden)}
                  className="mt-4 text-purple-600 font-medium hover:text-purple-800 transition-all duration-300"
                >
                  {showFullAiden ? "Read Less ↑" : "Read More ↓"}
                </button>
              </div>
            </div>
            ...
            <Card
              ...
              year={translations.ourProgress?.year2024 || "2024"}
              desc={
                "Techfist Global stands as a proud sponsor and technological partner of the We All Matter Alliance (WAM). As a leader in digital transformation and social innovation, Techfist is committed to empowering communities through the power of technology. By providing advanced digital solutions, strategic design, and scalable systems, Techfist enables organizations like WAM to amplify their impact across global networks. Our collaboration bridges innovation with purpose — creating platforms that inspire sustainability, inclusion, and collective growth. From powering digital campaigns to supporting AI-driven education, Techfist plays a vital role in accelerating WAM’s mission to make positive global change. Together, we are building a future where technology serves humanity — connecting people, empowering ideas, and ensuring every community has the tools to thrive."
              }
            />
          </div>
        </div>
