  ...
  return (
    <div className="relative w-full overflow-hidden border-b border-primary/30">
      ...
      >
        {/* Tagline */}
        <h2
          className="text-white text-2xl md:text-4xl lg:text-5xl mb-4 tracking-tight"
          style={{
            textShadow:
              "2px 2px 8px rgba(0,0,0,0.8), 0 0 20px rgba(139,92,246,0.5)",
          }}
        >
        ...
        {/* Subtitle */}
        <p
          className="text-primary text-sm md:text-lg lg:text-xl italic max-w-3xl"
          style={{
