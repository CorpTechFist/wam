...
export function VolunteerApplication() {
  ...
  const sendEmail = (e: React.FormEvent) => {
    ...
    emailjs
      .sendForm(
        "service_u6abwjq", // 🔹 Replace with your EmailJS Service ID
        "template_m0j6w73", // 🔹 Replace with your EmailJS Template ID
        formRef.current!,
        "OFD7Qlv7yYlrGs42z" // 🔹 Replace with your EmailJS Public Key
      )
      .then(
        () => {
    ...
    <div className="min-h-screen bg-white relative overflow-hidden">
                    ...
                    <div className="flex items-start gap-4 mb-6">
                      ...
                      <div>
                        ...
                        <p className="text-gray-800 leading-relaxed">
                          We are always looking for innovative ideas that serve
                          our mission!
                        </p>
                      </div>
                    </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div className="space-y-1">
          ...
          <Input
            type="text"
            id="volunteerFor"
            name="regarding"  // ✅ maps to {{regarding}} in template
            className="border-2 border-purple-200 focus:border-purple-500 rounded-none bg-white text-gray-900 h-9"
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="space-y-1">
          ...
          {/* ✅ Hidden input to pass the selected date to EmailJS */}
          <input
            type="hidden"
            id="dateAvailable"
            name="cityState"  // ✅ maps to {{cityState}} in template
      ...
      <div className="space-y-1">
        ...
        <Textarea
          id="skills"
          name="message"  // ✅ maps to {{message}} in template
          rows={3}
      ...
      <div className="bg-purple-50 border-2 border-purple-200 p-3">
        <div className="flex items-start space-x-2">
          ...
          <label
            htmlFor="agreement"
            className="text-xs text-gray-800 leading-snug cursor-pointer"
          >
            You are submitting your information so our Volunteer Unit may contact you
            via the information provided. We All Matter thanks you for your love and support!
          </label>
        </div>
      </div>
